...
from mass.st4.lists import authors, infos, all_ids, ids_by_caseId
...
def ddo(taba):
    ...
    for i in range(0, len(ids_tabs), length):
        ...
        print(f'tfj run mnx{num} --image python3.9 --command "$HOME/local/bin/python3 core8/pwb.py mass/st4/start3 get:{num} {len(tabs[str(num)])}"')
